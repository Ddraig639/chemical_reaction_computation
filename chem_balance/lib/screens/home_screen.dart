      ...
      body: SafeArea(
        child: Consumer<EquationProvider>(
          builder: (context, provider, child) {
            // Check if equation contains arrow
            final bool hasArrow = provider.currentEquation.contains('->');
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: _buildOperationButton(
                                    ...
                                    color: Colors.red,
                                    onLongPress: () => provider.clearEquation(),
                                  ),
                                ),
                              ],
                            ),
                                ...
                                return Expanded(
                                  child: Container(
                                    margin: const EdgeInsets.symmetric(
                                        horizontal: 4),
                                    child: ElevatedButton(
                                      onPressed: element.isEmpty
                                          ? null
                                          : () {
                                              if (provider.balancedResult !=
                                                  null) {
                                                provider.clearEquation();
                                              }
